...
$BackupDir = Join-Path $ScriptsDir ("_backup_fix_lib_allowed_signers_v8_" + $ts)
...
$marker = "# NEVERLOST_PATCH_V8_SSHKEYGEN"
if ($libText -notmatch [regex]::Escape($marker)) {
  $A = New-Object System.Collections.Generic.List[string]
  [void]$A.Add("")
  [void]$A.Add("# NEVERLOST_PATCH_V8_SSHKEYGEN")
  [void]$A.Add("# - Robust ssh-keygen.exe -Y resolver (prefers System32 OpenSSH)")
  [void]$A.Add("# - Defines NL-ResolveSshKeygenY and NL-RequireSshKeygenY (override-safe)")
  [void]$A.Add("")
  ...
  [void]$A.Add("}")
  [void]$A.Add("")
  [void]$A.Add("function NL-ResolveSshKeygenY {")
  ...
  [void]$A.Add("  }")
  [void]$A.Add("  throw ""NL-ResolveSshKeygenY: No ssh-keygen.exe with '-Y' support found. Enable Windows OpenSSH Client (System32) or ship a pinned portable OpenSSH.""")
  [void]$A.Add("}")
  [void]$A.Add("")
  [void]$A.Add("# Override-friendly: define/override NL-RequireSshKeygenY to use resolver")
  [void]$A.Add("function NL-RequireSshKeygenY { return (NL-ResolveSshKeygenY) }")
...
Write-Host ("OK: patch v8 complete. Backup at: " + $BackupDir) -ForegroundColor Green
